...
const NavButtonDropMobile = ({text,to,size, onClose} ) => {
    return (
        <Flex position="">
            <Button
            bg="rgba(0,0,0,0)"
            ...
            >
                <span style={{ padding: "0 5px 0 0", marginLeft: "-6px !important" }}>
                    {text}
                </span>
            ...
            <Box id="menu3" w="85vw" background="#FFF" mt="40px" ml="-100px" position="relative" border="1px solid #ddd" style={{ display:"none" }}>
...
export default NavButtonDropMobile
